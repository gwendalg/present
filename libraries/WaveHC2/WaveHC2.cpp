...
//------------------------------------------------------------------------------
/** create an instance of WaveHC2. */
WaveHC2::WaveHC2(void) {
  fd = 0;
}
//------------------------------------------------------------------------------
/**
 ...
 *  file with features that WaveHC2 does not support.
 */
uint8_t WaveHC2::create(FatReader &f) {
  // 18 byte buffer
 ...
 * Play a wave file.
 *
 * WaveHC2::create() must be called before a file can be played.
 *
 * Check the member variable WaveHC2::isplaying to monitor the status
 * of the player.
 */
void WaveHC2::play(void) {
 ...
 */
int16_t WaveHC2::readWaveData(uint8_t *buff, uint16_t len) {
 ...
 */
void WaveHC2::seek(uint32_t pos) {
 ...
 */
void WaveHC2::setSampleRate(uint32_t samplerate) {
